  ...
  try {
    for (const viewport of [{width:1140,height:820},{width:390,height:844}]) {
      ...
      await page.addInitScript(() => {
        ...
        const state={version:'0.4.0',device:{id,name:'My PC',port:53319,addresses:['192.168.1.10:53319']},peers:[{id:peer,name:'Pixel 7a',address:'192.168.1.20:53319',connected:true,trusted:false,ready:false,code:'483291',local_confirmed:false}],trusted:[],messages:[],transfers:[],warnings:[],receive_dir:'/test/received'};
    ...
    await page.addInitScript(() => {
      ...
      const state = {version:'0.4.0',device:{id:'a'.repeat(64),name:'Desktop',port:53319,addresses:['192.168.1.10:53319']},peers:[{id:peer,name:'Phone',address:'192.168.1.20:53319',connected:true,trusted:true,ready:true}],trusted:[],messages:[],transfers:[],warnings:[],receive_dir:'/test/received'};
      window.testCalls = [];
