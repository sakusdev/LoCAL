...
New versions: update Cargo workspace, Tauri config, desktop package/lock, Android version, packaging script and `release.json.tag`. v0.4.1 is marked prerelease.
