...
New versions: update Cargo workspace, Tauri config, desktop package/lock, Android version, packaging script and `release.json.tag`. v0.2.1 is marked prerelease.
